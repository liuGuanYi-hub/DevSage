...
| Hash 向量 + RRF | 0.7000 | 0.5167 | 0.6000 |

## 解读

当前混合基线在这批脱敏问题上提高了 Source Recall@5 和 MRR，但离生产可用仍有明显距离。下一步应替换 Hash Provider，接入真实 Embedding，并继续检查 Chunk 大小、中文分词、来源覆盖率和多来源问题的召回策略。
