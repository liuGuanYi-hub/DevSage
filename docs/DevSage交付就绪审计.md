...
| 离线交付门禁 | 已完成 | `scripts/verify-offline.ps1`，当前环境 16 步通过（含 pytest 和 actor capability smoke） |
| Actor 能力 HTTP smoke | 已完成 | `scripts/smoke-actors.ps1`；viewer/editor/operator 的允许、拒绝动作和 preview 不写盘均已由独立进程验证 |
